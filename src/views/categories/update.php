    ...
    <form method="post" action="?" class="card" data-parsley-validate>
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="category_name" id="category_name" class="form-control" value="<?= sp_post('category_name', $t['category.category_name']); ?>" maxlength="200" required>
        ...
        <div class="form-group">
          ...
          <input type="text" name="category_slug" id="category_slug" class="form-control" value="<?= sp_post('category_slug', $t['category.category_slug']); ?>" maxlength="200" required>
          <div class="form-text text-muted">
        ...
        <div class="form-group">
          ...
          <input name="category_icon" id="category_icon" class="form-control" value="<?= sp_post('category_icon', $t['category.category_icon']); ?>">
            ...
            <input type="number" name="category_order" id="category_order" class="form-control" value="<?= sp_post('category_order', $t['category.category_order']); ?>" maxlength="10" required>
            <div class="form-text text-muted">
        ...
        <div class="form-group d-none">
          ...
          <label class="custom-switch mt-3">
            ...
            <input type="checkbox" id="category_feat_at_home" name="category_feat_at_home" value="1" class="custom-switch-input" <?php checked(1, (int) sp_post('category_feat_at_home', $t['category.category_feat_at_home'])); ?>>
...
extend(
    ...
    'page_heading' => __('Update Category'),
    'page_subheading' => __('Modify existing category.'),
    ]
);
