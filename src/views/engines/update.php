...
<div class="row"><div class="container">
    ...
    <form method="post" action="?" class="card" data-parsley-validate>
      ...
      <div class="card-body">
            ...
            <input type="text" name="engine_name" id="engine_name" class="form-control" value="<?= sp_post('engine_name', $t['engine.engine_name']); ?>" maxlength="200" required>
            ...
            <input type="text" name="engine_cse_id" id="engine_cse_id" class="form-control" value="<?= sp_post('engine_cse_id', $t['engine.engine_cse_id']); ?>" maxlength="200" required>
            <div class="form-text text-muted">
        ...
        <div class="form-group">
          ...
          <label class="custom-switch mt-3">
            ...
            <input type="checkbox" id="engine_is_image" name="engine_is_image" value="1" class="custom-switch-input" <?php checked(1, (int) sp_post('engine_is_image', $t['engine.engine_is_image'])); ?>>
        ...
        <div class="form-group">
          ...
          <label class="custom-switch mt-3">
            ...
            <input type="checkbox" id="engine_show_thumb" name="engine_show_thumb" value="1" class="custom-switch-input" <?php checked(1, (int) sp_post('engine_show_thumb', $t['engine.engine_show_thumb'])); ?>>
            <span class="custom-switch-indicator"></span>
        ...
        <div class="form-group">
          ...
          <label class="custom-switch mt-3">
            ...
            <input type="checkbox" id="default_engine" name="default_engine" value="1" class="custom-switch-input" <?php checked(1, (int) sp_post('default_engine', $t['default_engine'])); ?>>
            <span class="custom-switch-indicator"></span>
...
extend(
    ...
    [
      'title' => __('Update Engine'),
      'body_class' => 'engines engines-create',
      'page_heading' => __('Update Engine'),
      'page_subheading' => __('Modify existing engine.'),
    ]
);
