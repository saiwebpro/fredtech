        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <span class="form-text">
                    <?php echo __("Are you sure you want to delete this plugin?"); ?>
                    </span>
                </div>
                <div class="form-group">
                    <a href="<?php echo e_attr(url_for('dashboard.plugins')); ?>" class="btn btn-outline-primary mr-1">
                        <?php echo __('Nope')?></a>
...
extend(
    ...
    [
      ...
      'body_class' => 'plugins plugins-delete',
      'page_heading' => __('Delete Plugin'),
      'page_subheading' => __('Remove existing plugin.'),
    ]
);
