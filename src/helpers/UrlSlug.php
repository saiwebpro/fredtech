...
class UrlSlug
{
    ...
    protected function doTransliterate($string)
    {
        ...
        if ('de_DE' == $this->options['locale'] || 'de_DE_formal' == $this->options['locale'] || 'de_CH' == $this->options['locale'] || 'de_CH_informal' == $this->options['locale']) {
            $char_map['Ä'] = 'Ae';
            $char_map['ä'] = 'ae';
            $char_map['Ö'] = 'Oe';
            $char_map['ö'] = 'oe';
            ...
            $char_map['ü'] = 'ue';
            $char_map['ß'] = 'ss';
        } elseif ('da_DK' === $this->options['locale']) {
            $char_map['Æ'] = 'Ae';
            $char_map['æ'] = 'ae';
            $char_map['Ø'] = 'Oe';
            $char_map['ø'] = 'oe';
            $char_map['Å'] = 'Aa';
            $char_map['å'] = 'aa';
        } elseif ('ca' === $this->options['locale']) {
            $char_map['l·l'] = 'll';
        } elseif ('sr_RS' === $this->options['locale'] || 'bs_BA' === $this->options['locale']) {
            $char_map['Đ'] = 'DJ';
            $char_map['đ'] = 'dj';
        }
